<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminGiris.aspx.cs" Inherits="ETicaretKitap.admin.adminGiris" %>
...
<body>
    ...
    <table align="center">
        ...
        <tr>
            <td class="auto-style1">Adınız</td>
            <td class="auto-style3">
                <asp:TextBox ID="txtUsername" runat="server" placeholder="adınızı giriniz" Width="170px"></asp:TextBox>
            </td>
        </tr>
        <tr>
